...
in {
  ...
  # DNS over HTTPS disabled - use system DNS
  "network.trr.mode" = 5; # 5 = disabled, 0 = off, 1 = fastest, 2 = backup, 3 = only, 4 = fastest and backup
  # "network.trr.custom_uri" = "https://dns.quad9.net/dns-query"; # Commented out
  # "network.trr.uri" = "https://dns.quad9.net/dns-query"; # Commented out
