{
  ...
  */
  ...
  services.tailscale = {
    ...
    # You can still use 'tailscale up' to authenticate
  };

  # Enable Docker service
  virtualisation.docker = {
    enable = true;
    # Enable Docker daemon with systemd socket activation
    enableNvidia = false; # Set to true if you have NVIDIA GPU and want GPU support
    # The service will be automatically enabled and started
  ...
  # Ensure Docker socket has correct permissions for the docker group
  ...
  # Configure Docker socket permissions - this is the correct way in NixOS
  ...
  # Ensure Docker service depends on the socket
  systemd.services.docker.requires = [ "docker.socket" ];
