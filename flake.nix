{
  ...
  outputs = {
    ...
    settings = {
      # User configuration
      username = "josval"; # automatically set with install.sh and live-install.sh
      editor = "vscode"; # nixvim, vscode, nvchad, neovim, emacs (WIP)
      browser = "firefox"; # firefox, floorp, zen
      terminal = "kitty"; # kitty, alacritty, wezterm
      terminalFileManager = "yazi"; # yazi or lf
      sddmTheme = "astronaut"; # astronaut, black_hole, purple_leaves, jake_the_dog, hyprland_kath
      wallpaper = "quasar"; # see modules/themes/wallpapers

      # System configuration
      videoDriver = "amdgpu"; # CHOOSE YOUR GPU DRIVERS (nvidia, amdgpu or intel)
      hostname = "NixOS"; # CHOOSE A HOSTNAME HERE
      locale = "es_ES.UTF-8"; # CHOOSE YOUR LOCALE
      timezone = "America/Lima"; # CHOOSE YOUR TIMEZONE
      kbdLayout = "es"; # CHOOSE YOUR KEYBOARD LAYOUT
      kbdVariant = ""; # CHOOSE YOUR KEYBOARD VARIANT (Can leave empty)
      consoleKeymap = "es"; # CHOOSE YOUR CONSOLE KEYMAP (Affects the tty?)
    };
